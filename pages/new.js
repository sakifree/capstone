...
const New = (props) => {
    ...
    return (
        ...
        <form className="w-full max-w-6xl mx-4 my-4" onSubmit={handleSubmit}>
            ...
            <div className="md:flex md:items-center mb-6">
                ...
                <div className="md:w-2/3">
                    <textarea className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" rows="10" cols="20" type="text" name="text" value={form.text} onChange={handleChange} placeholder="What's up.. " />
                </div>
            </div>
            <div className="md:flex md:items-center mb-6">
            </div>
